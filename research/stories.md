## Job story 1
**Situation**: When I need to quickly record something I must remember
**Motivation**: I want to add a task with as few steps as possible
**Outcome**: so I can save it without interrupting what I'm doing
**Underlying need** because long or effortful workflows make me avoid using task managers entirely
...
**Motivation**: I want the layout and controls to be simple, uncluttered, and easy to understand
**Outcome**:so I can complete actions confidently without getting confused or making mistakes
**Underlying need**:because unclear or overly complex interfaces overwhelm me and make it hard to know what each button does
